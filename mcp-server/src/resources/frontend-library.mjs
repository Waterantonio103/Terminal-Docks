...
const ROLE_SKILL_RECOMMENDATIONS = {
  ...
  frontend_architect: ['frontend_negatives', 'frontend_product_ui_patterns', 'frontend_forms_states', 'frontend_data_visualization'],
  frontend_builder: [
    'frontend_negatives',
  ...
  interaction_qa: ['frontend_negatives', 'frontend_browser_visual_qa', 'frontend_forms_states'],
  accessibility_reviewer: ['frontend_negatives', 'frontend_polish_review', 'frontend_browser_visual_qa'],
...
export function buildFrontendLibraryIndex() {
  ...
  return {
    ...
    workflow: [
      ...
      'For frontend design, build, QA, accessibility, or visual-polish roles, load frontend-skill://frontend_negatives before selecting optional effects or approving output.',
    ...
    guardrails: [
      ...
      'Treat frontend-skill://frontend_negatives as a rejection checklist, not optional inspiration.',
