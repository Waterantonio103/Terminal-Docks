...
const tempRoot = mkdtempSync(join(tmpdir(), 'comet-ai-debug-final-'));
...
try {
  ...
  const expectedDebugTools = [
    ...
    'debug_search_logs',
    'debug_capture_app_screenshot',
    'debug_list_ui_screenwatch_snapshots',
    'debug_read_ui_screenwatch_snapshot',
