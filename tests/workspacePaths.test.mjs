...
assert.equal(joinWorkspacePath('C:\\repo', '\\src\\App.tsx'), 'C:\\repo\\src\\App.tsx');
assert.equal(joinWorkspacePath('C:\\repo', '..\\secret.txt'), 'C:\\repo\\secret.txt');
assert.equal(joinWorkspacePath('C:\\repo', 'C:src\\App.tsx'), 'C:\\repo\\src\\App.tsx');
assert.equal(joinWorkspacePath('C:\\repo', 'C:\\outside\\App.tsx'), 'C:\\repo\\outside\\App.tsx');
assert.equal(joinWorkspacePath(' C:\\repo\\\u0000 ', 'src'), 'C:\\repo\\src');
assert.equal(joinWorkspacePath('C:\\repo', ' src/App.tsx\u0000 '), 'C:\\repo\\src\\App.tsx');
assert.equal(joinWorkspacePath('/repo', 'src'), '/repo/src');
assert.equal(joinWorkspacePath('/repo', 'src\\App.tsx'), '/repo/src/App.tsx');
assert.equal(joinWorkspacePath('/repo', '/src/App.tsx'), '/repo/src/App.tsx');
assert.equal(joinWorkspacePath('/repo', './src/../App.tsx'), '/repo/App.tsx');
assert.equal(joinWorkspacePath('/repo', '../../secret.txt'), '/repo/secret.txt');
assert.equal(joinWorkspacePath('/repo', ' src\\App.tsx\u0000 '), '/repo/src/App.tsx');
...
assert.equal(normalizeWorkspacePath('C:'), '');
assert.equal(normalizeWorkspacePath('C:repo\\src\\..\\App.tsx'), 'repo/App.tsx');
...
assert.equal(relativeWorkspacePath('\\\\Server\\Share', '\\\\server\\share\\dir\\file.txt'), 'dir/file.txt');
